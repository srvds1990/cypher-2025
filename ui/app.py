...
from db.vector_store import list_sessions
...
if st.session_state.selected_session:
    ...
    with col1:
        if st.button("📑 Summarize Session"):
            ...
            viz = result.get("viz_fig_data")
            if viz and viz.get("terms"):
                df = {"term": viz["terms"], "score": viz["scores"]}
                fig = px.bar(df, x="term", y="score", title="Top keywords")
